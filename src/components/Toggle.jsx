...
const Toggle = () => {
  ...
  return (
    <div
      ...
      className="mode flex justify-start bg-white w-10 h-6 rounded-full overflow-hidden   duration-500  relative cursor-pointer "
    >
      <div
        ref={btn}
        className="h-4 w-4 text-[#e5e5e5] bg-gray-700 rounded-full duration-300 top-1/2 -translate-y-1/2 absolute ml-1 left-0 flex items-center justify-center "
      >
        <i className="ri-moon-clear-fill text-xs"></i>
      </div>
      <div
        ref={cloud}
        className="baddal absolute bottom-[-100%]  duration-300 h-full w-full "
      >
      ...
      <div
        ref={star}
        className="stars absolute bottom-0  duration-300 h-full w-full "
      >
