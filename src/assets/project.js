let project = [

    {
        title: "Taara",
        desc: `
<section class="max-w-5xl mx-auto md:px-6 py-16">
  <!-- Project Header -->
  <header class="mb-12">
    <h1 class="text-3xl font-bold  mb-2">Taara</h1>
    <p class="text-sm ">
      A frontend clone project showcasing seamless animations using GSAP, smooth scrolling with Lenis, and modern design principles with Tailwind CSS.
    </p>
  </header>

  <!-- Project Description -->
  <section class="mb-12">
    <h2 class="text-xl font-semibold  mb-4">Project Goals</h2>
    <p class="text-sm lime-desc">
      Taara aims to demonstrate advanced frontend skills by combining modern technologies like GSAP and Lenis. The goal is to create a seamless and smooth user experience with minimal distractions, while maintaining a clean, responsive, and interactive layout.
    </p>
  </section>
  ...
  <footer class="border-t pt-6 mt-12">
    <p class="text-sm ">
      Taara demonstrates the power of modern web technologies in creating engaging, smooth, and responsive user experiences. This project highlights how seamless animations and intuitive scrolling can elevate the user interface to a whole new level.
    </p>
  </footer>
</section>
`,
    ...
    },
    {
        ...
        <section class="max-w-5xl mx-auto md:px-6 py-12">
  <!-- Header -->
  <header class="mb-10">
    <h1 class="text-3xl font-bold mb-2">Payment Animation Web App</h1>
    <p class="text-sm lime-desc">
      A modern, gesture-inspired UI that brings swipe-to-pay interactions and seamless transitions to the web.
    </p>
  </header>
  ...
  <footer class="border-t pt-6">
    <p class="text-sm">
      Crafted with care using HTML, Tailwind CSS, JavaScript, and GSAP — delivering a futuristic user interaction.
    </p>
  </footer>
</section>
...
`,
  ...
  <!-- Project Header -->
  <header class="mb-12">
    <h1 class="text-3xl font-bold  mb-2">Multiverse</h1>
    <p class="text-sm lime-desc">
      An innovative and visually captivating website offering a seamless and engaging user experience with smooth scrolling and fluid animations.
    </p>
  </header>
  ...
  <section class="mb-12">
    <h2 class="text-xl font-semibold  mb-4">Project Goals</h2>
    <p class="text-sm ">
      Multiverse aims to set a new benchmark in web design by integrating advanced visual effects while ensuring a high-performance, user-friendly experience. The goal is to create a website that is both visually stunning and functional, providing users with an unforgettable journey through the content.
    </p>
  </section>
  ...
  <footer class="border-t pt-6 mt-12">
    <p class="text-sm ">
      Multiverse is a prime example of how advanced web technologies can come together to create a visually stunning, high-performance, and user-friendly website. By combining smooth scrolling, seamless animations, and responsive design, Multiverse offers users an immersive journey through the content.
    </p>
  </footer>
</section>
  ...
  <!-- Project Header -->
  <header class="mb-12">
    <h1 class="text-3xl font-bold mb-2">Fintory</h1>
    <p class="text-sm lime-desc">
      A sleek and modern website blending minimalist design with advanced web technologies for a seamless user experience.
    </p>
  </header>
  ...
  <footer class="border-t pt-6 mt-12">
    <p class="text-sm">
      Fintory demonstrates how clean design, elegant motion, and modern performance can elevate a simple layout into a truly premium digital experience.
    </p>
  </footer>
</section>
...
<section class="max-w-5xl mx-auto md:px-6 py-16">
  <!-- Project Title -->
  <header class="mb-12">
    <h1 class="text-3xl font-bold mb-2">WandersGates Clone</h1>
    <p class="text-sm lime-desc" >
      A modern web experience combining smooth animations, immersive scrolling, and elegant interactivity.
    </p>
  </header>
  ...
  <footer class="border-t pt-6 mt-12">
    <p class="text-sm">
      Built with passion using HTML, Tailwind CSS, JavaScript, GSAP, and LocoMotive.js — delivering an immersive digital experience.
    </p>
  </footer>
</section>
`,
